...
class ConditionalVAE(VanillaDLGM):
    def __init__(
        ...
        **kwargs
        ...
        super(ConditionalVAE, self).__init__(
            ...
            label_params=self.plabel,
            *args,
            **kwargs
        )

    def make_encoders(
        self, input_params, latent_params, hidden_params, label_params, *args, **kwargs
    ):
        ...
        return super(ConditionalVAE, self).make_encoders(
            enc_input, latent_params, hidden_params
        )
    ...
    def make_decoders(
        ...
        return super(ConditionalVAE, self).make_decoders(
            input_params, latent_params_dec, hidden_params
        )
